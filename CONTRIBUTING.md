...
* Describe the feature that you're showcasing and link to other relevant parts of the
  documentation.
* SI units should be used in the example code for gallery plots. Furthermore, the usage of
  SI units in all comments and docstrings should follow the
...
* SI units should be used in the example code for tutorial plots. Furthermore, the usage of
  SI units in all comments and docstrings should follow the
  [SI unit rules and style conventions](https://physics.nist.gov/cuu/Units/checklist.html)
  (e.g. add a space between the numerical value and the unit symbol).
