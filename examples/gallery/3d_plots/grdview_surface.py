...
here controls the azimuth and elevation angle of the view. Specifying the same scale for
the ``projection`` and ``zscale`` parameters ensures equal axis scaling. The ``shading``
