...
- **j/J**: placed inside/outside the frame boundaries using any 2-character
...
fig.colorbar(
    cmap="oleron",
    # Colorbar placed outside the frame boundaries (J) at Middle Right (MR),
...
fig.colorbar(
    ...
    # Colorbar placed inside the frame boundaries (j) at Bottom Left (BL),
