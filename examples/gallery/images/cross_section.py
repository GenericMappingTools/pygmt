...
fig.colorbar(
    ...
    # Bottom Right and an offset (+o) of 0.7 centimeters and 0.3 centimeters
    # in x and y directions, respectively
    # Move the x label above the horizontal colorbar ("+ml")
    position="jBR+o0.7c/0.8c+h+w5c/0.3c+ml",
    # Add a box around the colobar with a white fill ("+g") with a
    # transparency ("@) of 30 % and a 0.8-points thick black solid outline
