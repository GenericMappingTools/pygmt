...
to plot: **b**\ ox, **c**\ ircle, **f**\ ault (default), **s**\ lip, or **t**\
riangle. Slip means left-lateral or right-lateral strike-slip arrows
...
**pen**). To use an alternate pen, append **+p**\ *pen*. To skip the
* outline, just use **+p** with no argument. To make the main front line
* invisible, add **+i**.
