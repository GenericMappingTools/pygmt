...
fig.basemap(
    region=[0, 10, 0, 10], projection="X10c/10c", frame=Frame(title="Cartesian hlines", axis=Axis(annot=True, tick=True))
)
...
fig.basemap(
    region=[0, 10, 0, 10], projection="X10c/10c", frame=Frame(title="Cartesian vlines", axis=Axis(annot=True, tick=True))
)
...
fig.basemap(region="g", projection="R15c", frame=Frame(title="Geographic hlines", axis=Axis(annot=True, tick=True)))
# Add a line at 70°N
...
fig.basemap(region="g", projection="R15c", frame=Frame(title="Geographic vlines", axis=Axis(annot=True, tick=True)))
# Add a line at 70°E
...
fig.basemap(region=[0, 360, 0, 1], projection="P10c", frame=Frame(title="Polar hlines", axis=Axis(annot=True, tick=True)))
...
fig.basemap(region=[0, 360, 0, 1], projection="P10c", frame=Frame(title="Polar vlines", axis=Axis(annot=True, tick=True)))
