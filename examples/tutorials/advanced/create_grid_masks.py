...
treat edges as inside, use the same value as ``inside``. When setting these values, keep
in mind you are creating the mask grid first which is thought to be applied to a real
grid in a second step.
