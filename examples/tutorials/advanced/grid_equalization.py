...
with fig.subplot(
    ...
    with fig.set_panel(panel=1):
        fig.histogram(
            ...
            series=[500, 3600, 100],
            frame=Frame(axes="wnSE", xaxis=Axis(annot=True, tick=True, label="Elevation (m)"), yaxis=Axis(annot=True, tick=True, label="Percent frequency")),
            cmap=True,
            histtype=1,
            pen="1p,black",
        )
...
with fig.subplot(
    ...
    with fig.set_panel(panel=1):
        fig.histogram(
            ...
            frame=Frame(axes="wnSE", xaxis=Axis(annot=True, tick=True, label="Relative elevation"), yaxis=Axis(annot=True, tick=True, label="Percent frequency")),
            cmap=True,
            histtype=1,
            pen="1p,black",
            center=True,
