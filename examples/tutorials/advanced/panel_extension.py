...
========================================
*Please run the following code examples in a notebook enviorement, e.g.,
...
create interacitve dashboards by connecting user-defined widgets to plots.
...
# Download grid for Earth relief
