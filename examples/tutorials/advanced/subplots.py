...
# %%
# We start by drawing the bottom two subplots, setting ``tag="b)"`` so
...
# uses ``tag="a)"``, and we also plotted some text inside. Note that
...
# %%
# You can also manually override the ``tag`` for each subplot using for
