...
#============ylabel
fig.text(x=-1.7, y=10, text='frame="y+lylabel"', font="10p,8", justify="CM", angle=90, no_clip=True)
#============x-majorticks
fig.plot(x=10, y=-0.2, style="c1c", pen="2p,darkblue", no_clip=True)
fig.text(x=10, y=-1.4, text="Annonate", font="12p,2,darkblue", justify="TC" , no_clip=True)
...
fig.text(x=0, y=23.2, text="Annonate", font="12p,2,darkblue", justify="TC" , no_clip=True)
