...
fig.basemap(region=[-5, 5, -5, 5], projection="X5c", frame=Frame(axes="WStr", axis=Axis(annot=True, tick=True)))
...
fig.basemap(region=[-30, 30, 10, 60], projection="L0/35/23/47/5c", frame=Frame(axes="wSnE", axis=Axis(annot=True, tick=True)))
