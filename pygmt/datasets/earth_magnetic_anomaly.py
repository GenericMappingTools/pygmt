...
def load_earth_magnetic_anomaly(
    ...
    *@earth_mag.cpt* for ``data_source="emag2"`` and
    ...
    ``data_source="wdmam"``. It's implicitly used when passing in the file name
    of the dataset to any grid plotting method if no CPT is explicitly
    specified. When the dataset is loaded and plotted as an
