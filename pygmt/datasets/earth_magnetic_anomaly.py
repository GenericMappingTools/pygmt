...
def load_earth_magnetic_anomaly(
    ...
    **earth_mag4km**, and **earth_wdmam**. *res* is the grid resolution
    ...
    The default color palette tables (CPTs) for this dataset are *@earth_mag.cpt*
    for ``data_source="emag2"`` and ``data_source="emag2_4km"``, and
    *@earth_wdmam.cpt* for ``data_source="wdmam"``.
    ...
    dataset-specific CPT, you need to explicitly set ``cmap="@earth_mag.cpt"``
    or ``cmap="@earth_wdmam.cpt"``.
