...
class ClipAccessor:
    ...
    def land(self, **kwargs):
        ...
        return _clip_context(
            figure,
            activate=lambda: figure.coast(land=True, **kwargs),
            deactivate=lambda: figure.coast(Q=True),
        )
    ...
    def water(self, **kwargs):
        ...
        """
        figure = self._figure
        # Activate the clipping by `coast -S` and deactivate by `coast -Q`.
        return _clip_context(
            figure,
            activate=lambda: figure.coast(water=True, **kwargs),
            deactivate=lambda: figure.coast(Q=True),
        )
    ...
    def dcw(self, code: str | Sequence[str], **kwargs):
        ...
        >>> fig.show()
        """
        _code = sequence_join(code, sep=",")
        figure = self._figure
        # Activate the clipping by `coast -E<code>+c` and deactivate by `coast -Q`.
        return _clip_context(
            figure,
            activate=lambda: figure.coast(E=f"{_code}+c", **kwargs),
            deactivate=lambda: figure.coast(Q=True),
        )
    ...
    def solar(self, invert: bool = False, **kwargs):
        ...
        """
        figure = self._figure
        # Activate the clipping by `solar -G` and deactivate by `clip -C`.
        _kwargs = kwargs | {"fill": True, "N": invert}
        return _clip_context(
            figure,
            activate=lambda: figure.solar(**_kwargs),
    ...
    def polygon(
        ...
        **Aliases**
        ...
        figure = self._figure
        # Activate the clipping by `clip` and deactivate by `clip -C`.
        return _clip_context(
            figure,
    ...
    def mask(
        ...
        **Aliases**
        ...
        # Activate the clip by `mask` and deactivate by `mask -C`.
        return _clip_context(
            figure,
