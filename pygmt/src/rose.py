...
def rose(  # noqa: PLR0913
    ...
    **kwargs,
    ...
    $frame
        Remember that here *x* is the radial distance and *y* is the azimuth. The y label
        may be used to plot a figure caption. The scale bar length is determined by the
        radial gridline spacing.
