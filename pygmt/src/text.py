...
def text_(  # noqa: PLR0912
    ...
    **kwargs,
    ...
    non-ASCII characters defined in the Adobe ISOLatin1+ encoding, the Adobe Symbol and
    ZapfDingbats character sets, and ISO-8859-x (x can be 1-11, 13-16) encodings. Refer
    to :doc:`techref/encodings` for the full list of supported non-ASCII characters.
