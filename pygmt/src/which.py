...
def which(
    ...
    **kwargs,
    ...
    downloading from the GMT data server, or any of the remote datasets listed at
    `PyGMT datasets <https://www.pygmt.org/latest/api/index.html#datasets>`_. In these
    cases, use the ``download`` parameter to set the desired behavior. If ``download``
    ...
    **Aliases:**
    ...
    download
        ...
        - any of the GMT remote datasets listed at
          `PyGMT datasets <https://www.pygmt.org/latest/api/index.html#datasets>`_
